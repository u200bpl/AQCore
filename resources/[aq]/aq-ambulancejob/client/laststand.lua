        ...
        CreateThread(function()
            while InLaststand do
                ...
                elseif LaststandTime - 1 <= 0 then
                    AQCore.Functions.Notify("Je bloed dood..", "error")
                    SetLaststand(false)
...
RegisterNetEvent('hospital:client:UseFirstAid', function()
    if not isEscorting then
        ...
        AQCore.Functions.Notify('Actie onmogelijk!', 'error')
    end
end)
...
RegisterNetEvent('hospital:client:HelpPerson', function(targetId)
    ...
    AQCore.Functions.Progressbar("hospital_revive", "Peroon helpen..", math.random(30000, 60000), false, true, {
        ...
        ClearPedTasks(ped)
        AQCore.Functions.Notify("Je hebt iemand geholpen")
