...
Config.Locations = {
    ...
    ["stations"] = {
        [1] = {label = "Ziekenhuis", coords = vector4(304.27, -600.33, 43.28, 272.249)}
    }
}
...
Config.BleedingStates = {
    [1] = {label = 'bloed een beetje..', damage = 10, chance = 50},
    [2] = {label = 'bloed..', damage = 15, chance = 65},
    [3] = {label = 'bloed hevig..', damage = 20, chance = 65},
    [4] = {label = 'bloed extreem..', damage = 25, chance = 75},
}
