...
$(document).on('click', '.save-bindings', function(e){
    ...
    $.post('https://aq-commandbinding/save', JSON.stringify({
        keyData: keyData
    }));
});

aBinding.Open = function(data) {
...
aBinding.Close = function() {
    $(".container").fadeOut(150);
    $.post('https://aq-commandbinding/close');
}