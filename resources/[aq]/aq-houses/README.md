# aq-houses
Real Estate for aq-core Framework :house_with_garden:
...
- [aq-radialmenu](https://github.com/AQCore-framework/aq-radialmenu) - For the menu in screenshots
- [aq-anticheat](https://github.com/AQCore-framework/aq-anticheat) - Anti Cheat 
- [aq-phone](https://github.com/AQCore-framework/aq-phone) - Houses app
- [aq-multicharacter](https://github.com/AQCore-framework/aq-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
- [aq-garages](https://github.com/AQCore-framework/aq-garages) - House Garage
- [aq-interior](https://github.com/AQCore-framework/aq-interior) - Necessary for house interiors
- [aq-clothing](https://github.com/AQCore-framework/aq-clothing) - Outfits
- [aq-weathersync](https://github.com/AQCore-framework/aq-weathersync) - Desync weather inside house
- [aq-weed](https://github.com/AQCore-framework/aq-weed) - Weed plant
- [aq-skillbar](https://github.com/AQCore-framework/aq-skillbar) - Skills
...
- Import `aq-houses.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure aq-core
ensure aq-radialmenu
ensure aq-anticheat
ensure aq-phone
