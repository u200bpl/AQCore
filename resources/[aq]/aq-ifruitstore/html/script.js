...
$(document).ready(function() {
    ...
    window.addEventListener('click',function() {
        ...
        if (distance < HitDistance) {
            ...
            MainDigits--;
            $.post("https://aq-ifruitstore/thermiteclick");
...
Thermite.Failed = function() {
    if (active) $.post("https://aq-ifruitstore/thermitefailed");
    active = false;
    Thermite.Close();
}

Thermite.Success = function() {
    if (active) $.post("https://aq-ifruitstore/thermitesuccess");
    active = false;
    Thermite.Close();
}
...
Thermite.Close = function() {
    ...
    $.post('https://aq-ifruitstore/closethermite');
}