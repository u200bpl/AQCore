...
- [aq-logs](https://github.com/AQCore-framework/aq-logs) - For logging transfer and other history
- [aq-traphouse](https://github.com/AQCore-framework/aq-traphouse) - Trap house system for AQCore
- [rp-radio](https://github.com/AQCore-framework/rp-radio) - Radio system for communication
- [aq-drugs](https://github.com/AQCore-framework/aq-drugs) -  Drugs and weeds system
- [aq-shops](https://github.com/AQCore-framework/aq-shops) - Needed in order to add shops
...
- Import `aq-inventory.sql` in your database
