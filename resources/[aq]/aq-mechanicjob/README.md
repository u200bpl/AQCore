# aq-mechanicjob
Mechanic Job for aq-core Framework :mechanic:
...
- [aq-inventory](https://github.com/AQCore-framework/aq-inventory) - 
...
- Import `aq-.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure aq-core
ensure aq-inventory
ensure aq-mechanicjob
```
