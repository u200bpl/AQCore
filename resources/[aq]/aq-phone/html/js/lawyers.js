            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        AQ.Phone.Notifications.Add("fas fa-phone", "Phone", "You are already connected to a call!");
                    }
                } else {
                    AQ.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is already in a call");
                }
            } else {
