...
- Add `start aq-queue` inside your server.cfg. - *Preferrably at the top*
- Set convars to your liking.
- Open `aq-queue/server/sv_queue_config.lua` and edit to your liking.
...
## How to use / Examples
---
To use the API add `server_script "@aq-queue/aq-queue.lua"` at the top of the `__resource.lua` file in question.
I would also suggest adding `dependency "aq-queue"` to it aswell.
