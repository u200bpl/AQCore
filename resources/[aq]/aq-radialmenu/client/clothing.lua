...
RegisterNetEvent('aq-radialmenu:ResetClothing')
AddEventHandler('aq-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('aq-radialmenu:ToggleClothing')
AddEventHandler('aq-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('aq-radialmenu:ToggleProps')
AddEventHandler('aq-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	AQCore.Functions.Notify(message, color)
end
