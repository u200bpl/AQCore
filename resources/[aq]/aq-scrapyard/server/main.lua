...
RegisterServerEvent('aq-scrapyard:server:LoadVehicleList')
AddEventHandler('aq-scrapyard:server:LoadVehicleList', function()
    local src = source
    TriggerClientEvent("aq-scapyard:client:setNewVehicles", src, Config.CurrentVehicles)
end)


RegisterServerEvent('aq-scrapyard:server:ScrapVehicle')
AddEventHandler('aq-scrapyard:server:ScrapVehicle', function(listKey)
    local src = source 
    ...
    if Config.CurrentVehicles[listKey] ~= nil then 
        ...
        TriggerClientEvent("aq-scapyard:client:setNewVehicles", -1, Config.CurrentVehicles)
    end
end)
