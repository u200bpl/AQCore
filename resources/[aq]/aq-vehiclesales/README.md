# aq-vehiclesales
Used Car Sale for aq-core Framework :blue_car:
...
- [aq-garages](https://github.com/AQCore-framework/aq-garages) - Vehicle ownership
- [aq-phone](https://github.com/AQCore-framework/aq-phone) - For the e-mail
- [aq-logs](https://github.com/AQCore-framework/aq-logs) - Keep event logs
...
- Import `aq-vehiclesales.sql` in your database
...
ensure aq-vehiclesales
```

## Configuration
- To adjust tax, go to aq-vehiclesales\server\main.lua row 85 and change "77" to your liking
```
Config = Config or {}
