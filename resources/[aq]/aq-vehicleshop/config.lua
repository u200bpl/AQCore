    ...
    [1] = {
        ...
        ["ShowroomVehicles"] = {
            [1] = {
                ...
                defaultVehicle = 'chiron17', -- The vehicle that needs to be there on restart
                chosenVehicle = 'chiron17', -- Keep this the same as defaultvehicle
            ...
            [2] = {
                ...
                defaultVehicle = 'camry55',
                chosenVehicle = 'camry55',
                inUse = false,
                buying = false,
            },
            [3] = {
