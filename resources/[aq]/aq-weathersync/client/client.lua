...
RegisterNetEvent('AQCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('aq-weathersync:server:RequestStateSync')
    TriggerServerEvent('aq-weathersync:server:RequestCommands')
end)

RegisterNetEvent('aq-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('aq-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('aq-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('aq-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('aq-weathersync:client:RequestCommands', function(isAllowed)
    if isAllowed then
...
RegisterNetEvent('aq-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
