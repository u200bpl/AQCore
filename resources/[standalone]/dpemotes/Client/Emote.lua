...
AddEventHandler('animations:client:EmoteCommandStart', function(args)
  if CanDoEmote then
    ...
    AQCore.Functions.Notify("Cannot Be Done Right Now", "error")
  end
end)
...
function EmoteCommandStart(source, args, raw)
    ...
    if name == "c" then
        if IsInAnimation then
          ...
          AQCore.Functions.Notify('No Emote To Cancel', 'error')
        end
      return
    ...
    elseif DP.PropEmotes[name] ~= nil then
      ...
      AQCore.Functions.Notify('That Is Not A Valid Command', 'error')
    end
  end
end
