...
CreateThread(function()
	if not Config.Framework then
		...
		if state ~= 'missing' then
			...
			Config.Framework = (framework == 'es_extended') and 'ESX' or 'AQ'
		end
	end
	...
	elseif Config.Framework == 'AQ' then
		...
		RegisterNetEvent('AQCore:Client:OnGangUpdate', function(GangInfo)
